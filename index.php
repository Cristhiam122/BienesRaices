...
?>
        ...
        <div class="contenedor-anuncio">
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <a href="anuncios.php" class="boton boton-amarilloB">Ver Propiedad</a>
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <a href="anuncios.php" class="boton-amarilloB">Ver Propiedad</a>
    ...
    <div class="contenedor sesccion seccion-inferior">
        ...
        <section class="blog">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        <source srcset="build/img/blog1.webp" type="image/sebp">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p>Consejos para construir una terraza en tu casa con los menjores materiales y ahorrando dinero</p>
                    </a>
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        <source srcset="build/img/blog2.webp" type="image/sebp">
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se comportó de una excelente forma, muy bena atención y la casa que me ofrecieron cumple con todas mis expectativas.
                </blockquote>
                <p>- Cristhiam Aguirre</p>
            </div>
